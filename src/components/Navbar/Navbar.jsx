...
export default function Navbar() {
  ...
  // ✅ Obtener totalItems del contexto del carrito
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-[10px] relative">
          ...
          >
            {/* ✅ Mostrar número real de productos del carrito */}
        ...
        <>
          ...
          <div
            className={`absolute z-[1100] transition-all duration-500 ease-out ${
              showCartDropdown ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'
            }`}
            style={{
